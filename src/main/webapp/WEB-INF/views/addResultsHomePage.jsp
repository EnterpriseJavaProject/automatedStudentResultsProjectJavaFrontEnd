...
<option value="Deactivate">Deactivate</option>		     
        ...
        <div class="container">
		<button type="button" hidden="true" class="btn btn-info float-left" data-toggle="modal" data-target="#courseAndModule">Add Module</button>
...
<option value="${findCourseNameAndCourseLevel.course_name}">
	...
	${findCourseNameAndCourseLevel.course_name }---${findCourseNameAndCourseLevel.course_level }
...
<!--  
      <select name="module_name" class="form-control" id="default" required="required">
<option value="">Select Module</option>
		...
		<option value="Fundamentals of Computing">Fundamentals of Computing</option>
...
<c:forEach items="${findStudentNameAndStudentID}" var="findStudentNameAndStudentID">

							
							
				<c:url value="findModulesUnderEachCourseById" var="viewModuleURL">
					<c:param name="id" value="${findStudentNameAndStudentID.id }"></c:param>
					<c:param name="course_name" value="${findStudentNameAndStudentID.student_id }"></c:param>
					<c:param name="module_name" value="${findStudentNameAndStudentID.name }"></c:param>
				</c:url>
				...
				<tr>
					...
					<td>${findStudentNameAndStudentID.name }</td>
					<td>${findStudentNameAndStudentID.student_id }</td>
					
					
		<td> <input name="marks" type="text" class="form-control" id="marks" value="" required> </td>
