...
<div class="container">
		<button type="button" class="btn btn-info float-left" data-toggle="modal" data-target="#myModal">Add Results</button>
		...
		<div class="modal fade" id="myModal" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
					<h4 class="modal-title text-primary" style="text-align: center;">ADD STUDENT RESULTS</h4>
					...
					<div class="modal-body">
						...
						<form action="" method="post">
							...
							<div class="modal-body">
								...
								<div class="form-group">
									...
									<select class="form-control" name="course_level" required="required">
										<option value="">Select Course</option>
										<option value="Certificate in Software Development" onclick="csd()">Certificate in Software Development</option>
										<option value="Cisco Certified Network Associate" id="csd">Cisco Certified Network Associate</option>
										<option value="Cisco Certified Network Professionals" id="csd">Cisco Certified Network Professionals</option>
										<option value="International Computer Driving Licence" id="csd">International Computer Driving Licence</option>
										<option value="Cyber Security" id="csd">Cyber Security</option>
										<option value="Network Information Security" id="csd">Network Information Security</option>
										<option value="Certified Information System Auditor" id="csd">Certified Information System Auditor</option>
										<option value="Big Data Analytics" id="csd">Big Data Analytics</option>
										<option value="Web Technologies" id="csd">Web Technologies</option>
										<option value="Java Programming" id="csd">Java Programming</option>
										<option value="Computing Infrastructure Systems & Security" id="csd">Computing Infrastructure Systems & Security</option>
									</select>
								</div>
								...
								<div class="form-group">
									...
									<select class="form-control" name="student_name" required="required">
						...
						<div class="modal-footer">
								    <button type="submit" class="btn btn-primary" onclick="return validate()" id="alert">Declare Results</button>
	...
	<tbody>
			...
			<c:forEach items="${allAitiKaceStudents}" var="allAitiKaceStudents">
				...
				<c:url value="updateStudentInfo" var="csd1_1Students">
					...
					<c:param name="course" value="${allAitiKaceStudents.course_level }"></c:param>
					...
					<c:param name="reg_date" value="${allAitiKaceStudents.reg_date }"></c:param>
					...
					<c:param name="update_time" value="${allAitiKaceStudents.update_time }"></c:param>
