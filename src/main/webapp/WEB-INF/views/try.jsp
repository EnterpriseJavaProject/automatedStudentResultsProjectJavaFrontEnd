...
<br><br>
   ...
   <br><br>
	...
	<form action="${pageContext.request.contextPath }/aitiKaceModulesApiConsumption/saveResults" method="post">
        ...
        <tr style="font-size:20px;font-weight:bolder;color:black;">
        
                		<th>COURSE NAME : <br> ${param.course_name } </th>
                		
				<th>MODULE NAME : <br> ${param.module_name } </th>
				<th>STAFF NAME  : <br> ${param.staff_name } </th>    
...
<c:forEach items="${retrieveAllStudentsUnderResults}" var="retrieveAllStudentsUnderResults">
	

			<tr>
					<th> <input name="studentname" readonly="readonly" value="${retrieveAllStudentsUnderResults.name }"> </th>
					<th> <input name="studentid" readonly="readonly" value="${retrieveAllStudentsUnderResults.student_id }"> </th>
					
					<th> <input type="text" name="marks" value="${retrieveAllStudentsUnderResults.marks }" required> </th>
 ...
 <button type="submit" class="btn btn-primary" style="margin-left:600px;" onclick="return validate()" id="alert">Upload Results</button>
