      ...
      <div class="card-body p-0">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <div class="p-5">
  <a href="${pageContext.request.contextPath }/aitiKaceAdminApiConsumption/getAllStudentInfo=VIEW=ADMIN-JJD-DN-OSPS-PAGE-Jkdiso=dDFSFUJD-DNDNjfdhnd=dkdoeyrijfd-cnfsd"><img src="${pageContext.request.contextPath }/resources/images/back.png" width="30px" height="30px"></a>
 
              <div class="text-center">
              <img src="${pageContext.request.contextPath }/resources/images/aiti.png" alt="">
              <br><br>
                <h1 class="h4 text-gray-900 mb-4"> LOGIN AUTHENTICATION REQUIRED</h1>
              </div>
              ...
              <div class="social-icons">
				...
				<span style="color:red;"><center>Incorrect Admin Username and Password ! Try again</center></span>

                <form class="user" action="${pageContext.request.contextPath }/aitiKaceAdminApiConsumption/getAdminLogin=VIEW=adMIN-PAGE=iDH-MMihhds=SIDFF-djIhd=mOiJD=JDHD" method="POST">

            <div class="form-group">
                  <input type="text" name="username" class="form-control form-control-user" value="${param.username}" placeholder="Enter Admin Username..." required>
                </div>
