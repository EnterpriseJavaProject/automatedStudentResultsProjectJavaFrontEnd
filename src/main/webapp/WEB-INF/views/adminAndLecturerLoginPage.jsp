...
<a href="${pageContext.request.contextPath }/aitiKaceAdminApiConsumption/getLoginBackHomePage=GO=BACK-TO=HOME-PAGE=ODP-SDSHJD=SDJD-DJSJ=D=Z=O=-SJ-DDN-DD-DMNC"><img src="${pageContext.request.contextPath }/resources/images/back.png" width="30px" height="30px"></a>
              ...
              <br><br>
                <h1 class="h4 text-gray-900 mb-4"> ADMIN AND LECTURER LOGINS </h1>
              </div>
              ...
              <form class="user" action="${pageContext.request.contextPath }/aitiKaceModulesCoursesApiConsumption/staffsLogin" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                  <input type="password" name="password" class="form-control form-control-user" value="${param.password}" placeholder="Password" required>
                </div>
