      ...
      <div class="card-body p-0">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <div class="p-5">
  <a href="${pageContext.request.contextPath }/aitiKaceStudentsApiConsumption/getAllStudentInfo=VIEW=ADMIN-JJD-DN-OSPS-PAGE-Jkdiso=dDFSFUJD-DNDNjfdhnd=dkdoeyrijfd-cnfsd"><img src="${pageContext.request.contextPath }/resources/images/back.png" width="30px" height="30px"></a>
