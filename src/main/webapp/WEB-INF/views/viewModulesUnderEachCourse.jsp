  ...
  <div class="card-body">
	...
	<tbody>
			...
			<c:forEach items="${getAllModulesUnderEachCourseById}" var="getAllModulesUnderEachCourseById">
				...
				<c:url value="findModulesUnderEachCourseById" var="viewModulesURL">

					<c:param name="module_name" value="${viewModulesURL.module_name }"></c:param>
					<c:param name="staff_name" value="${viewModulesURL.staff_name }"></c:param>
					...
					<c:param name="id" value="${getAllModulesUnderEachCourseById.id }"></c:param>
				</c:url>


				<tr>
				
					<td>${getAllModulesUnderEachCourseById.staff_name }</td>
					<td>${getAllModulesUnderEachCourseById.module_name }</td>

					
					
					<td><a href="${viewModulesURL }"><i class="fa fa-edit color-primary" title="View Modules"></i></a>
					<!-- 
