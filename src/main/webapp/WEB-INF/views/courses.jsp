...
<option value="Deactivate">Deactivate</option>		     
        ...
        <div class="container">
		<button type="button" class="btn btn-info float-left" data-toggle="modal" data-target="#courseAndModule">Add Course</button>
		...
		<div class="modal fade" id="courseAndModule" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
					<h4 class="modal-title text-primary">ADD COURSE</h4>
						<button type="button" class="close" data-dismiss="modal">&times;</button>						
					</div>
					<div class="modal-body">
						...
						<form action="${pageContext.request.contextPath }/aitiKaceCoursesApiConsumption/saveCourses" method="post">
  	...
  	<select name="course_group" id=selectCourseGroup class="form-control">
   ...
   <div class="col">
   								...
   								<div class="form-group">
									<label>CERTIFICATION DATE</label> <input name="certificate_issuedate" type="date"
										class="form-control checking_date_of_birth" id="certificate_issuedate" value=""  required>
