...
<c:forEach items="${updateStudentResults}" var="updateStudentResults">
	

			<tr>
					<th> <input name="" readonly="readonly" value="${updateStudentResults.name }"> </th>
					<th> <input name="" readonly="readonly" value="${updateStudentResults.student_id }"> </th>
					
					<th> <input type="text" name="marks" value="${updateStudentResults.marks }" required> </th>
