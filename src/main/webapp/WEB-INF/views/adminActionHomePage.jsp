			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form action="${pageContext.request.contextPath }/aitiKaceAdminApiConsumption/saveAitiKaceStudent=SaMEmE=HsuSGS-MlsjHS-DN-aDDF-Fdddde-sAmKoG=SmO-sLnINbds=LonCrshs-bBidbdd" method="post">
	...
	<tbody>
			...
			<c:forEach items="${allAitiKaceStudents}" var="allAitiKaceStudents">
				...
				<c:url value="updateStudentInfo" var="csd1_1Students">
					...
					<c:param name="gender" value="${allAitiKaceStudents.address }"></c:param>
					<c:param name="phone" value="${allAitiKaceStudents.date_of_birth }"></c:param>
					<c:param name="phone" value="${allAitiKaceStudents.reg_date }"></c:param>
					<c:param name="gender" value="${allAitiKaceStudents.course_start_date }"></c:param>
					<c:param name="phone" value="${allAitiKaceStudents.course_end_date }"></c:param>
					<c:param name="gender" value="${allAitiKaceStudents.update_time }"></c:param>
