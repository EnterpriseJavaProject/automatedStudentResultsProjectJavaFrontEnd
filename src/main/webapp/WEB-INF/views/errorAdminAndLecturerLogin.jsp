...
<div class="row justify-content-center">
  ...
  <a href="${pageContext.request.contextPath }/aitiKaceAdminApiConsumption/getLoginBackHomePage=GO=BACK-TO=HOME-PAGE=ODP-SDSHJD=SDJD-DJSJ=D=Z=O=-SJ-DDN-DD-DMNC"><img src="${pageContext.request.contextPath }/resources/images/back.png" width="30px" height="30px"></a>
              ...
              <div class="social-icons">
				...
				<span style="color:red;"><center>Incorrect Admin Or Lecturer Username and Password ! Try again</center></span>

                <form class="user" action="${pageContext.request.contextPath }/aitiKaceModulesCoursesApiConsumption/staffsLogin" method="GET">

            <div class="form-group">
                  <input type="email" name="email" class="form-control form-control-user" value="${param.email}" placeholder="Enter Admin Username..." required>
                </div>
