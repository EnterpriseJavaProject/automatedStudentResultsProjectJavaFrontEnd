...
<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseNine" aria-expanded="true" aria-controls="collapseNine">
  ...
  <div id="collapseNine" class="collapse" aria-labelledby="headingNine" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      ...
      <a class="collapse-item" href="#">LECTURER PROFILE</a>
...
<div class="container">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
						...
						<form action="editAitiKaceLecturerInfo=VIEw=aLlsTudENTs-hBSIS=STUDENTS-GbsGhHS=PAGE-hGhgKg=VGSN=Vhanxjjj-hsdSBDSHNDHNNDH-Gh=yOPPJD" method="post">
							...
							<div class="modal-body">
								...
								<div class="form-group">
									<label>LECTURER NAME</label> <input name="name"
										type="text" class="form-control" value="${param.name}" required>
								</div>
 
								<div class="form-group">
									<label>EMAIL</label> <input name="email"
										type="email" class="form-control" value="${param.email}" required>
								</div>

								<div class="form-group">
									<label>PHONE NUMBER</label> <input name="phone" type="number"
										class="form-control" value="${param.phone}" required>
								</div>

								<div class="form-group">
									<label>COURSE HANDLE</label> <input name="course_handle" type="text"
										class="form-control" value="${param.course_handle}" required>
								</div>
