...
<br><br>
   ...
   <br><br>
	...
	<form action="${pageContext.request.contextPath }/aitiKaceStudentsApiConsumption/saveStudents" method="post">
						...
						<div class="row">
								...
								<label>STUDENT NAME</label>
								 <input name="name"
										type="text" class="form-control" id="name" value="" placeholder="Student Name" required>
							...
							<label>STUDENT ID</label>
								<div class="form-group">
									<input name="student_id" type="text" class="form-control checking_staff_id" id="staff_id" value="" placeholder="Student ID" required>
						...
						<div class="row">
   							 <div class="col">
									...
									<select name="course_name" class="form-control" onchange="setCourseName(this.id, 'selectCourseName')" required="required">
										<option value="">Select Course and Course Level</option>
										
										
			<c:forEach items="${findAllCourseNameAndCourseLevel}" var="findAllCourseNameAndCourseLevel">			
				
<option value="${findAllCourseNameAndCourseLevel.course_name}">${findAllCourseNameAndCourseLevel.course_name }---${findAllCourseNameAndCourseLevel.course_level }</option>
	...
	<tbody>
			...
			<c:forEach items="${allAitiKaceStudents}" var="allAitiKaceStudents">
				...
				<c:url value="getCsd1_2StudentById" var="updateURL">
					...
					<c:param name="name" value="${allAitiKaceStudents.name }"></c:param>
					<c:param name="fees" value="${allAitiKaceStudents.fees }"></c:param>
					...
					<c:param name="contact" value="${allAitiKaceStudents.contact }"></c:param>
					<c:param name="status" value="${allAitiKaceStudents.status }"></c:param>
					<c:param name="created_at" value="${allAitiKaceStudents.created_at }"></c:param>
					<c:param name="updated_at" value="${allAitiKaceStudents.updated_at }"></c:param>
				...
				<tr>
					...
					<td>${allAitiKaceStudents.name }</td>
					<td>${allAitiKaceStudents.course_name }</td>
					<td>${allAitiKaceStudents.gender }</td>
					<td>${allAitiKaceStudents.email }</td>
					<td>${allAitiKaceStudents.date_of_birth }</td>
					<td>${allAitiKaceStudents.contact }</td>
					<td>${allAitiKaceStudents.fees }</td>
					<td>${allAitiKaceStudents.status }</td>
					<td>${allAitiKaceStudents.created_at }</td>
					<td>${allAitiKaceStudents.updated_at }</td>
...
function setCourseName(s1,s2) {
	...
	if(s1.value == "CERTIFICATE IN SOFTWARE DEVELOPMENT---CSD1.1") {
