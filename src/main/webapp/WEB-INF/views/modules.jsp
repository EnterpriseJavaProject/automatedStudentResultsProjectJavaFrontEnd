...
<br><br>
        ...
        <h1 class="h2 mb-0 text-gray-800 text-center">AITI-KACE MODULES DASHBOARD</h1>
...
<option value="Deactivate">Deactivate</option>		     
        ...
        <div class="container">
		<button type="button" class="btn btn-info float-left" data-toggle="modal" data-target="#courseAndModule">Add Module</button>
		...
		<div class="modal fade" id="courseAndModule" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
					<h4 class="modal-title text-primary">ADD MODULE</h4>
						<button type="button" class="close" data-dismiss="modal">&times;</button>						
					</div>
					<div class="modal-body">
	...
	<form action="${pageContext.request.contextPath }/aitiKaceModulesApiConsumption/saveModules" method="post">
			...
			<div class="modal-body">
						...
						<div class="row">
   							 <div class="col">
   							 	...
   							 	<div class="form-group">
									<label>COURSE AND COURSE LEVEL</label> 
									<select name="course_name" id="course_name" class="form-control" onchange="showCoursesModlues(this.id, 'modules')" required="required">
										<option value="">Select Course and Course Level</option>
										
										
			<c:forEach items="${findCourseNameAndCourseLevel}" var="findCourseNameAndCourseLevel">			
				
<option value="${findCourseNameAndCourseLevel.course_name}">

			
	${findCourseNameAndCourseLevel.course_name }
   ...
   <div class="col">
	...
	<select name="module_name" id=modules class="form-control" required="required">
      ...
      <select name="staff_name" class="form-control" id="default" required="required">
<option value="">Select Staff</option>

			<c:forEach items="${retrieveOfAllInstructors}" var="retrieveOfAllInstructors">			
				
<option value="${retrieveOfAllInstructors.name }"> 
			
						${retrieveOfAllInstructors.name }
    ...
    <div class="col">
								...
								<div class="form-group">
									<label>MODULE START DATE</label> <input name="module_start_date" type="date"
										class="form-control checking_date_of_birth" id="course_start_date" value="" required>
  ...
  <div class="col">     
								...
								<div class="form-group">
									<label>MODULE END DATE</label> <input name="module_end_date" type="date"
										class="form-control checking_date_of_birth" id="course_end_date" value="" required>
										<span class="error_date_of_birth" id="date_of_birth_error_message" style="color:red;"></span>
								</div>
...
<a href="${pageContext.request.contextPath }/aitiKaceModulesApiConsumption/showAllStudentResults">  Add Results</a>
...
<c:forEach items="${getAllModules}" var="getAllModules">
	

																		
				<c:url value="showAllStudentResults" var="updateCoursesModulesURL">
					<c:param name="id" value="${showAllModules.id }"></c:param>
					<c:param name="module_name" value="${getAllModules.module_name }"></c:param>
					<c:param name="staff_name" value="${getAllModules.staff_name }"></c:param>
	
				</c:url>
				
				
			<c:url value="updateStudentResults" var="updateStudentResultsURL">
					<c:param name="id" value="${getAllModules.id }"></c:param>
					<c:param name="module_name" value="${getAllModules.module_name }"></c:param>
					<c:param name="staff_name" value="${getAllModules.staff_name }"></c:param>
				...
				<tr>
					...
					<td>${getAllModules.module_name }</td>
					<td>${getAllModules.staff_name }</td>
					<td>${getAllModules.status }</td>
					<td>${getAllModules.created_at }</td>
					<td>${getAllModules.updated_at }</td>
				
					<td><a href="${updateStudentResultsURL }"><i>Upload Results</i></a></td>
						<!-- 
						
						<a href="${updateCoursesModulesURL }">  <i>Upload Results</i></a> |
						
					<td><a href="${updateCoursesModulesURL }"><i>View</i></a> </td>
